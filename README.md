...
- **Real-Time Map Workspace**: Integrated with MapLibre GL for viewing deep-sea anomaly detections across different harbors (e.g., Mumbai Harbor Q3).
- **Temporal Comparison**: Historical tracking of structural anomalies over time.
- **Human Review System**: Dashboard tailored for human validators to verify or reject AI-detected anomalies.
- **Deep Water Mesh Aesthetics**: Features a modern, dark-themed UI that simulates a subsea environment with glassmorphic elements and ambient glow.
